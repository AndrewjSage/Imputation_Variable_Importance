...
MVVIMP <- parSapply(cl=cl, X=1:100,FUN=function(i){Del_Impute_wrapper(data=xyabv, xvarvec=c(1,4,6,7),pvec=c(0, 0.1, 0.25, 0.5, 0.75), ntrees=500, missingness="MCAR")} )
stopCluster(cl)


save(MVVIMP, file="MVVIMP_BH_MCAR.Rdata")
