...
MVVIMP <- parSapply(cl=cl, X=1:100, FUN=function(i){Gen_Del_Impute(rho=0.5, xvarvec=c(1,5),pvec=c(0, 0.1, 0.25, 0.5, 0.75), size=1000, ntrees=500)})
stopCluster(cl)

save(MVVIMP, file="MVVIMP_sim50.Rdata")